...
@TestPropertySource(properties = ["spring.batch.job.names=chunkParallelExecutionJob"])
class ChunkParallelExecutionJobConfigurationTest : BatchTestConfig() {

    @Test
    fun `run chunkParallelExecutionJob`() {
        // given
