...
@TestPropertySource(properties = ["spring.batch.job.names=chunkAndItemProcessorAsyncJob"])
class ChunkAndItemProcessorAsyncJobConfigurationTest : BatchTestConfig() {

    @Test
    fun `run chunkAndItemProcessorAsyncJob`() {
        // given
